...
<!--more-->
Source: [lpender3672/3D_printer](https://github.com/lpender3672/3D_printer)
...
## Rebuild with an aluminium extrusion frame
The original wooden ply was a bit warped from where it got wet long before i sourced it which meant the axes were not that square.
I'm slowly rebuilding the printer around a stiffer aluminium extrusion frame.
The plan is also to have a little custom pcb and stm32.

![](/assets/img/projects/3Dprinter/second_assembly.jpeg)
